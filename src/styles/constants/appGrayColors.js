...
export const appTransparentGrayColors = {
  five: `${rgba(appGrayColors.black, 0.05)}`,
  twenty: `${rgba(appGrayColors.black, 0.2)}`,
  thirty: `${rgba(appGrayColors.black, 0.3)}`,
  fifty: `${rgba(appGrayColors.black, 0.5)}`,
  eighty: `${rgba(appGrayColors.black, 0.8)}`,
}
